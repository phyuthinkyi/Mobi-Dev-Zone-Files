        ...
        <View style={styles.context}>
          ...
          <View style={styles.cardContainer}>
            <View style={styles.addToCartContainer}>
              <Text style={styles.title}>{route.params.product.name} MAKE THE SENTENCE LONGER THAN ORIGIN</Text>
...
const styles = StyleSheet.create({
  ...
  title: {flex: 1, color: color.primary, fontSize: 18, fontWeight: 'bold' },
