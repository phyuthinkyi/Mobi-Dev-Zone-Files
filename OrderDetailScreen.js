        ...
        <View style={{ flex: 1, padding: 15 }}>
          ...
          <View style={styles.bigDivider} />
          {
            ...
            orderDetailData.prodList.map((item, index) => {
              ...
              return (
                <>
                  <View key={index} style={styles.titleRowContainer}>
...
const styles = StyleSheet.create({
  textRight: { textAlign: 'right', color: color.textGray, fontSize: 14 },
  textBold: { color: color.textGray, fontSize: 18, fontWeight: 'bold', marginTop: 5 },
  textNormal: { color: color.textGray, fontSize: 14 },
  titleRowContainer: { flexDirection: 'row', paddingLeft: 5, paddingVertical: 10, alignItems: 'center' },
  textRightBold: { textAlign: 'right', color: color.textGray, fontSize: 18, fontWeight: 'bold', marginTop: 5 },
  bigDivider: { height: 2, backgroundColor: color.textGray },
  smallDivider: { marginLeft: 5, height: 1, backgroundColor: color.textGray },
